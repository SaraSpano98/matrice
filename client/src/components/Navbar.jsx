...
import RisorseSelector from "./shared/RisorseSelector";
...
const Navbar = () => {
  ...
  const buttonStyle =
    "flex items-center gap-2 p-2 text-gray-700 hover:text-dark dark:text-gray-500 dark:hover:text-light " +
    "hover:bg-violet-600 hover:dark:bg-purple-900 hover:shadow-lg hover:dark:shadow-purple-700 " +
    ...
    <nav className="fixed top-0 w-full z-50 bg-primary/95 dark:bg-secondary/95 backdrop-blur border-b border-gray-300 dark:border-gray-600">
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-5 flex items-center justify-between relative">
        ...
        <div className="md:hidden flex items-center gap-2">
          <button
            onClick={() => toggleDarkMode(!darkMode)}
            className="text-dark dark:text-light text-lg p-2 rounded hover:bg-violet-600 hover:dark:bg-purple-900 transition"
          >
            {darkMode ? "🌙" : "☀️"}
          </button>
          ...
          <button
            ...
            className="text-dark dark:text-light text-xl p-2 rounded hover:bg-violet-600 hover:dark:bg-purple-900 transition"
          >
            {isMobileMenuOpen ? "✖" : "☰"}
          </button>
        </div>
